...
function startSpeechRecognition() {
    ...
    recognition.onresult = (event) => {
        ...
        let response = "Hi, I'm DocBot, an AI assistant.";
        ...
        switch (spokenText.toLowerCase()) {
            ...
            case "hey, what's your name?":
                response = "Hello!, I'm Healthcare chat-bot, build by Telehealth Architects, How can i assist you today";
                break;
            ...
            case "i love you":
                ...
                break;
            case "hi":
                response = "Hi, I'm DocBot, an AI assistant for Healthcare.";
                break;
            case "नमस्ते":
                response = "मैं अच्छा हूँ,तुम कैसे हो?";
                break;
            case "What you can do":
                response = "Hi, I'm yout assistant";
                break;
...
sendButton.addEventListener("click", () => {
    ...
    switch (userMessage.toLowerCase()) {
        ...
        case "नमस्ते":
            response = "मैं अच्छा हूँ,तुम कैसे हो?";
            break;
        case "who is TeleHealth Architects":
            response = "I'm Telehealth Architect's assistant";
            break;
        case "What's the recommended daily intake of water for adults?":
            response = "The recommended daily water intake for adults varies but is typically around 8-10 glasses or 2-2.5 liters.";
            break;
